              ...
              <h3>{t("home.twoheader")}</h3>
                {i18nextLng === "az" ? (
                  <p>
                    ...
                    baxımından yaddaqalan bir təcrübə yaşatmaq olub.
                    Yeməklərimiz yerli və mövsümi məhsullardan hazırlanır.
                    Aşpazlarımız həm Azərbaycan mətbəxinin klassiklərini –
                    qutab, dolma, kabab və s. – həm də müxtəlif ölkələrin dadlı
                    yeməklərini özəl üsullarla təqdim edirlər. Restoranımızın
                    interyeri təbiətə açılan geniş sahələri, sakit və rahat
                    atmosferi ilə həm fərdi, həm ailəvi, həm də işgüzar görüşlər
                    üçün əlverişlidir.
                  </p>
                ) : i18nextLng === "en" ? (
                  "en"
