...
const MenuSection = ({ menuRef }) => {
    ...
    const handleScroll = () => {
      if (navbarRef.current) {
        ...
        timeoutId = setTimeout(() => {
          ...
          // Navbar sadece viewport üstüne ulaştığında sticky olacak
          if (navbarTop <= 0 && !isNavbarSticky) {
            setIsNavbarSticky(true);
          } else if (navbarTop > 0 && isNavbarSticky && !isScrollingDown) {
  ...
  return (
    <section className="menuSection" id="menu" ref={menuRef}>
      <div
                ...
                >
                  <div className="menuItemCard">
                    <div className="menuItemImage">
                      <img
                        src={`src/assets/menu/${item.image_url}`}
                        alt={
